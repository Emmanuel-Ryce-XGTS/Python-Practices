...
# Create letter_to_points dictionary using a list comprehension and zip
letter_to_points = {letter: point for letter, point in zip(letters, points)}
# Add the blank tile to letter_to_points
letter_to_points[" "] = 0
...
# Print the player_to_points dictionary
print("Player Points:", player_to_points)